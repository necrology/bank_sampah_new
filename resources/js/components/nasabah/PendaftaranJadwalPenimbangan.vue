...
export default {
    ...
    methods: {
        async fetchJadwalPeriode() {
            try {
                ...
                const response = await axios.get(
                    "http://localhost:8000/api/fetchJadwalPeriode"
                );
        ...
        async fetchJadwal(forceRefresh = false) {
            ...
            try {
                const response = await axios.get(
                    "http://localhost:8000/api/getJadwalPendaftaran",
                    {
                        params: {
        ...
        async updateJadwal() {
            ...
            try {
                ...
                const response = await axios.put(
                    `http://localhost:8000/api/updateDataJadwal/${this.editForm.id_jadwal}`,
                    dataToSend,
                    {
                        headers: {
                            Authorization: `Bearer ${this.user.token || ""}`,
