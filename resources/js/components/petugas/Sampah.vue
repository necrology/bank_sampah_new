                        ...
                        <template v-if="filteredSampah.length > 0">
                            ...
                            >
                                ...
                                <td>
                                    ...
                                    <button
                                        @click="
                                            deleteSampah(sampahItem.id_sampah)
                                        "
...
export default {
    ...
    methods: {
        async fetchSampah() {
            try {
                const response = await axios.get(
                    "http://202.10.47.115:8000/api/getSampah"
                );
        ...
        async addSampah() {
            try {
                await axios.post(
                    "http://202.10.47.115:8000/api/addDataSampah",
                    this.newSampah
                );
        ...
        async deleteSampah(id) {
            if (confirm("Apakah Anda yakin ingin menghapus data ini?")) {
                try {
                    await axios.delete(
                        `http://202.10.47.115:8000/api/deleteDataSampah/${id}`
                    );
        ...
        async updateSampah() {
            try {
                await axios.put(
                    `http://202.10.47.115:8000/api/updateDataSampah/${this.editSampahData.id}`,
                    {
